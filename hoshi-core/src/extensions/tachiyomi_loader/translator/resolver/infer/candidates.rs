...
pub static CANDIDATES: &[Candidate] = &[
    ...
    Candidate {
        name: "client",
        signals: &[
            Signal { kind_tag: SignalTag::ReceiverOf("newCall"),    weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("newBuilder"), weight: 0.5 },
            Signal { kind_tag: SignalTag::GetterShaped,             weight: 0.05 },
        ],
    },
    ...
    // HttpSource method-shaped fields
    Candidate {
        name: "popularMangaRequest",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCall", 0),            weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("asObservableSuccess"),       weight: 1.0 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("page"),       weight: 0.5 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "searchMangaRequest",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCall", 0),             weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("asObservableSuccess"),        weight: 1.0 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("query"),       weight: 0.8 },
            Signal { kind_tag: SignalTag::GetterShaped,                             weight: 0.05 },
        ],
    },
    Candidate {
        name: "latestUpdatesRequest",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCall", 0),             weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("asObservableSuccess"),        weight: 1.0 },
            Signal { kind_tag: SignalTag::GetterShaped,                             weight: 0.05 },
    ...
    Candidate {
        ...
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCall", 0),             weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("asObservableSuccess"),        weight: 1.0 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("getUrl"),     weight: 0.7 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
    ...
    Candidate {
        name: "imageUrlRequest",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCall", 0),             weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("asObservableSuccess"),        weight: 0.9 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("getUrl"),     weight: 0.6 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "imageRequest",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCachelessCallWithProgress", 0), weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("awaitSuccess"),               weight: 0.9 },
            Signal { kind_tag: SignalTag::PassedToKnown("getImageUrl", 0),         weight: 0.8 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },

    // HttpSource parse methods — these receive a Response and return model objects

    Candidate {
        name: "popularMangaParse",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("map", 0),                 weight: 0.6 },
            Signal { kind_tag: SignalTag::ResultPushedToList,                      weight: 0.5 },
            // returns MangasPage — mangas list + hasNextPage
            Signal { kind_tag: SignalTag::ReceiverOf("iterator"),                  weight: 0.4 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "searchMangaParse",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("map", 0),                 weight: 0.6 },
            Signal { kind_tag: SignalTag::ResultPushedToList,                      weight: 0.5 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("query"),      weight: 0.7 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "latestUpdatesParse",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("map", 0),                 weight: 0.6 },
            Signal { kind_tag: SignalTag::ResultPushedToList,                      weight: 0.5 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
    ...
    Candidate {
        name: "mangaDetailsParse",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("setTitle", 0),            weight: 0.9 },
            Signal { kind_tag: SignalTag::PassedToKnown("setAuthor", 0),           weight: 0.8 },
            Signal { kind_tag: SignalTag::PassedToKnown("setStatus", 0),           weight: 0.8 },
            Signal { kind_tag: SignalTag::PassedToKnown("setThumbnail_url", 0),    weight: 0.8 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "chapterListParse",
        signals: &[
            Signal { kind_tag: SignalTag::ResultPushedToList,                      weight: 0.7 },
            Signal { kind_tag: SignalTag::PassedToKnown("setDate_upload", 0),      weight: 0.8 },
            Signal { kind_tag: SignalTag::PassedToKnown("setChapter_number", 0),   weight: 0.8 },
            Signal { kind_tag: SignalTag::Iterated,                                weight: 0.3 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        ...
        signals: &[
            Signal { kind_tag: SignalTag::ResultPushedToList,                      weight: 0.7 },
            Signal { kind_tag: SignalTag::PassedToKnown("setImageUrl", 0),         weight: 0.9 },
            Signal { kind_tag: SignalTag::StoredFrom("Page"),                      weight: 0.8 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "imageUrlParse",
        signals: &[
            Signal { kind_tag: SignalTag::ReceiverOf("attr"),                      weight: 0.9 },
            Signal { kind_tag: SignalTag::ReceiverOf("src"),                       weight: 0.8 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("abs:src"),    weight: 1.0 },
            Signal { kind_tag: SignalTag::AppearsAfterStringLiteral("src"),        weight: 0.7 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    ...
    Candidate {
        name: "headers",
        signals: &[
            Signal { kind_tag: SignalTag::PassedToKnown("newCall", 1),             weight: 0.9 },
            Signal { kind_tag: SignalTag::PassedToKnown("GET", 1),                 weight: 1.0 },
            Signal { kind_tag: SignalTag::ReceiverOf("newBuilder"),                weight: 0.5 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
    Candidate {
        name: "network",
        signals: &[
            Signal { kind_tag: SignalTag::ReceiverOf("client"),                    weight: 0.9 },
            Signal { kind_tag: SignalTag::ReceiverOf("defaultUserAgentProvider"),  weight: 1.0 },
            Signal { kind_tag: SignalTag::GetterShaped,                            weight: 0.05 },
        ],
    },
];
